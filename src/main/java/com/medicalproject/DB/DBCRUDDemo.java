...
import static com.medicalproject.Appointments.createAppointment;
...
//        registerDoctor(567, "pass3", "Time Travel", "Doctor Who", 1234567, "theDoctor@gmail.com");
        ...
        System.out.println(DBCRUD.getNewID("Doctors", "DoctorID"));
        createAppointment("11:00","24/12/2024","Orthopedics");
    }
}
